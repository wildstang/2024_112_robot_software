...
public final class ArmConstants {
    ...
    public static final double AMP_POS = 107 * Math.PI / 180.0;
    public static final double MIN_INTAKE_POS = ZERO_OFFSET;
    public static final double MAX_INTAKE_POS = 80;  // TODO: confirm max angle that still intakes consistently
}